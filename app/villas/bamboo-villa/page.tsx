...
export default function BambooVillaPage() {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="space-y-8">
              ...
              <p className="text-base md:text-lg leading-[1.8] text-[#2a3444]/75 font-light">
                Step into a space where bamboo accents and earthy tones create a warm, inviting atmosphere. The open-plan living area flows seamlessly onto a private deck overlooking the river, while the bedrooms offer restful retreats with plush bedding and natural light filtering through lush surroundings.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="relative md:row-span-2 overflow-hidden h-full min-h-[500px]">
              <Image src="/bamboo-1.jpg" alt="Bamboo Villa Exterior" fill className="object-cover" />
            </div>
            <div className="relative aspect-[4/3] overflow-hidden">
              <Image src="/bamboo-2.jpg" alt="Bedroom" fill className="object-cover" />
            </div>
            <div className="relative aspect-[4/3] overflow-hidden">
              <Image src="/bamboo-3.jpg" alt="Living Area & Kitchen" fill className="object-cover" />
            </div>

            {/* Row 2: two side by side */}
            <div className="relative aspect-[4/3] overflow-hidden">
              <Image src="/bamboo-4.jpg" alt="Living Room" fill className="object-cover" />
            </div>
            <div className="relative aspect-[4/3] overflow-hidden">
              <Image src="/bamboo-5.jpg" alt="Kitchen Counter" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-28 md:py-36">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6">
          <h2
            ...
            style={{ fontVariant: "small-caps", fontFamily: "var(--font-serif), serif" }}
          >
            Ready to experience Bamboo Villa?
          </h2>
